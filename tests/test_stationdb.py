...
def test_get_thumbs_downed_history(station_db):
    ...
    station_db.add_track_to_or_update_history(station_id, track1, False)
    time.sleep(0.1)  # Ensure different timestamps
    station_db.add_track_to_or_update_history(station_id, track2, True)
    time.sleep(0.1)  # Ensure different timestamps
    station_db.add_track_to_or_update_history(station_id, track3, True)
